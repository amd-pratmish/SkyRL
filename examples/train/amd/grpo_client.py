...
trains the policy with the public ``cispo`` loss.
"""
...
CISPO_CONFIG = {"clip_low_threshold": 0.0, "clip_high_threshold": 5.0}
...
def train_policy(
    ...
    for minibatch in chunked(list(trajectories), 32):
        ...
        forward_result = training_client.forward_backward(data, "cispo", CISPO_CONFIG).result()
